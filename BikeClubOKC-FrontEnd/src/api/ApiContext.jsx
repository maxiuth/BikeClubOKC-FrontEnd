/**
 * ApiContext attaches the user's authentication token to API reqquests when possible
 * It also handles tags to refresh appropriate queries after mutations
 */
...
export function ApiProvider({ children }) {
  ...
  /**
   * Makes an APi call an dparses the response as JSOn if possible.
  ...
  /** Invalidates a tag by calling its stored query function */
